...
pip install -q transformers datasets accelerate peft 'trl==0.15.2' mergekit bitsandbytes sentencepiece safetensors sympy wandb playwright pytest huggingface_hub lm-eval tensorboard numpypython -m playwright install chromium
