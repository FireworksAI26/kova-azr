...
pip install -q torch transformers datasets accelerate peft "trl>=0.15,<0.18" bitsandbytes sentencepiece safetensors sympy wandb playwright pytest huggingface_hub lm-eval tensorboard numpy
